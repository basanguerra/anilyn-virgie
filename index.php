            ...
            <li class="breadcrumb-item">
              <img src="logo.png" width="1070px" height="250px" style="text-align: center;">
                ...
                <div class="panel-body">
                  <p> Green CHMSC excels, excellence competence and educational leadership in science and technology. Driven by its passion for continues improvement the state college has to vigorously puscience and tecrsue distinctions and profeciency in delivering the statutory function to the filipino people in the field of education, business, agro fishieries, industrial, hnology through commited and compitence human resource guided by the beacon of innovation of productivity towards the heights of elevated status..<br>
                  </p>
                </div>
                            </div>
                          </div>
                ...
                <div class="panel-body">
                  <p>A leading green institution in higher and continuing education committed to engage in quality instruction, development-oriented research, sustainable lucrative economic enterprise, and responsive extension and training services through relevant academic programs to empower a human resource that responds effectively to challenges in life and act as catalyst in the holistic development of a humane society.<br>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div>
                              <div class="panel-body">
                                <p>Carlos Hilado Memorial State College shall primarily provide higher technological, professional and vocational instruction and training in science/agricultural, in industrial fields as well as short-term technical or vocational courses. It shall provide research advance studies and progressive leadership in its areas of specialization.<br>
                </p>
                              </div>
                            </div>
                          </div>
