...
<footer>
    <div class="container">
      <div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
        <h4>Contact Us</h4>
        <p>Carlos Hilado Memorial State College-Binalbagan SSG Office</p>           
        <div class="contact-info">
          <ul>
            <li><i class="fa fa-home fa"></i>Brgy. Enclaro, Binalbagan, Negros Occidental </li>
            <li><i class="fa fa-phone fa"></i> +63 9508750147</li>
            <li><i class="fa fa-envelope fa"></i>cmscbinssg@gmail.com</li>
          </ul>
        </div>
      </div>
